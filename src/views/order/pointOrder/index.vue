        ...
        <el-table :data="datas"
            ...
            <el-table-column min-width="150"
                ...
                <template v-slot="scope">
                    <div class="font-weight-bold hot-color">{{ scope.row.order_number }}</div>
                </template>
            </el-table-column>
            <el-table-column min-width="150"
                             label="點數紀錄">
                <template v-slot="scope">
                    <div class="font-weight-bold gray-color">更新前:<span class="ml-2">{{ scope.row.before_point | formatCurrency }}</span></div>
                    <div class="font-weight-bold hot-color">新增:<span class="ml-2">{{ scope.row.point | formatCurrency }}</span></div>
                    <div class="font-weight-bold red-color">更新後:<span class="ml-2">{{ scope.row.after_point | formatCurrency }}</span></div>
                </template>
            </el-table-column>
            <el-table-column min-width="150"
                             label="會員">
                <template v-slot="scope">
                    <div class="font-weight-bold hot-color">名稱:<span class="ml-2">{{ scope.row.user_member.name }}</span></div>
                    <div class="font-weight-bold red-color">帳號:<span class="ml-2">{{ scope.row.user_member.account }}</span></div>
                </template>
            </el-table-column>
            <el-table-column min-width="150"
                             label="操作人員">
