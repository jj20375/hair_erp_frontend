    ...
    <div>
        ...
        <el-table :data="datas"
            ...
            <el-table-column min-width="150"
                             label="標籤創建者">
                <template v-slot="scope">
                    <div class="font-weight-bold red-color">帳號:<span class="ml-2">{{ scope.row.createuser_able.account }}</span></div>
                    <div class="font-weight-bold hot-color">名稱:<span class="ml-2">{{ scope.row.createuser_able.name }}</span></div>
                </template>
            </el-table-column>
