        ...
        <div class="table-responsive"
            ...
            <el-table :data="datas"
                ...
                <el-table-column label="名稱"
                    ...
                    <template v-slot="scope">
                        <div>
                            <h5 class="mb-0 dark-color">
                                帳號:<span class="ml-2">{{ scope.row.account }}</span>
                            </h5>
                            <h5 class="mb-0 gray-color font-weight-bold">
                                名稱:<span class="ml-2">{{ scope.row.name }}</span>
                            </h5>
                            <h5 class="mb-0 text-primary font-weight-bold">
                                暱稱:<span class="ml-2">{{ scope.row.nickname }}</span>
                            </h5>
                            <h5 class="mb-0 red-color font-weight-bold"
                                v-if="user.group.group_code === 'SYSTEM'">
                                管理者帳號:<span class="ml-2">{{ scope.row.user_operator.account }}</span>
                            </h5>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="時間/登入ip"
                                 min-width="200">
                    <template v-slot="scope">
                        <div class="gray-color borderBottomWidth1 grayBorder">
                            創建時間:
                            <div class="ml-2">
                                {{ scope.row.created_at | formatDateTime }}
                            </div>
                        </div>
                        <div class="font-weight-bold borderBottomWidth1 grayBorder">
                            最後登入:
                            <div class="ml-2">
                ...
                <el-table-column label="設置"
                    ...
                    <template v-slot="scope">
                        <base-button outline
                                     ...
                                     @click="goToPanel(scope.row)">控制台</base-button>
                        <base-button outline
                                     size="sm"
                                     type="primary"
                                     class="mt-1"
...
/**
 * DesignerUserListApi = 取得設計師列表
 * DesignerUserListByIdApi = 取得指定id設計師列表
 * UpdateDesignerApi = 更新設計師
 */
...
export default {
    ...
    methods: {
         ...
         * @example { user_id: users表id designer_id: user_designers表id, operator_id: 隸屬管理者id, status: 狀態值 }
