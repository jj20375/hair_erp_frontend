<template>
    <el-dialog :title="`${submitText}設計師`"
        ...
        <el-form :label-position="'right'"
            ...
            <el-row :gutter="10">
                <el-col :span="20">
                    <el-form-item>
                        <label class="d-block">設計師圖片</label>
...
export default {
    ...
    methods: {
        ...
        /**
         * 刪除設計師圖片
         * @param { type String or Number (字串或數字) } 設計師id
         */
        ...
        async onSubmit(formName) {
            ...
            try {
                ...
                /**
                 * 此判斷式目的在於判斷是否為系統 協助新增設計師帳號
                 * 1. 如果網址上id 沒有參數值時 代表為管理者自行新增設計師帳號
                 * 2. 如果網址上id 有參數值時 代表為系統使用者協助新增設計師帳號
                 * ps. 管理者只能建立自己底下的設計師帳號 不可幫分店管理者做建立設計師帳號
                 */
        ...
        /**
         * 取得設計師資料
         * @param { type String or Number(字串或數字) }account 設計師帳號
         */
        ...
        openDialog() {
            ...
            if (self.checkEdit) {
                 ...
                 * 2. 如果網址上有id 參數的話 代表此為系統人員操作 協助新增設計師帳號 因此 抓取參數值為網址 id 參數
                 */
