<template>
    <div>
        ...
        <ReportPerformance :searchOperator="searchOperator" :datas="datas" :loading="loading" />
    </div>
</template>
...
/**
 * ReportPerformanceApi = 總業績api
 */
import { ReportPerformanceApi } from "../../../api/reportApi";
...
export default {
    ...
    methods: {
        ...
        async getReport(searchData) {
            ...
            self.loading = true;
            try {
                let { data } = await ReportPerformanceApi(searchData);
